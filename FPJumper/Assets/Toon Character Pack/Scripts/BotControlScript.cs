...
public class BotControlScript : MonoBehaviour
{
	 ...
	 void Jump()
	{
		...
		bool CurrentlyJumping = true;
		//float moveX = Input.GetAxis("Horizontal") * 1 * Time.deltaTime;

  		//float moveZ = Input.GetAxis("Vertical") * 1 * Time.deltaTime;

 		//float moveY = Input.GetAxis("Jump") * 1 * Time.deltaTime;
